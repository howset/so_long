...
/*   Updated: 2024/06/14 14:11:51 by hsetyamu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	img = mlx_xpm_file_to_image(img->mlx_img, PLAYER_XPM, &SPR_WIDTH, &SPR_HEIGHT);
}
...
int	render(t_data *data)
{
	...
	//render_sprite(&data->img, (t_sprite){0, 0, SPR_WIDTH, SPR_HEIGHT, RED_PIXEL});
